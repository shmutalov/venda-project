 ...
 *
 */
$drupal_hash_salt = 'WW_6fBzLQlOw9H91A78Ui3U0mEbaendzfZuUkGaTxCo';
...
$conf['404_fast_paths'] = '/\.(?:txt|woff|png|gif|jpe?g|css|js|ico|swf|flv|cgi|bat|pl|dll|exe|asp)$/i';
...
/**
 * Enable the following if you have Memcache installed.
 */
