		...
		<table class="table table-striped table-hover warehouse-export-csv">
			...
			<tbody>
				<tr>
					...
					<td>
						<input type="text" name="products[nid][barcode]" placeholder="Штрих-код" class="form-control form-text required product-barcode input-sm" maxlength="14" disabled="disabled"/>
					</td>
					<td class="product-parts">
						<div class="row small-col-padding">
							...
							<div class="col-sm-3 small-col-padding date-expire">
								<input type="text" value="" placeholder="Срок годности" disabled="disabled" class="form-control form-text input-sm"/>
							</div>
						</div>
					</td>
...
<div class="warehouse-export-csv-actions">
	<button type="button" name="op" value="Создать CSV файл" class="btn btn-success form-submit">Создать CSV файл</button>
</div>