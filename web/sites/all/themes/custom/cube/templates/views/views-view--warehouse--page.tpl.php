...
<div class="<?php print $classes; ?>">
  ...
  <?php if ($footer): ?>
    <div class="view-footer">
      <?php print $footer; ?>
      <?php 
      $prices = get_total_prices($_GET);
      $opt_price = call_user_func( $rate_round_side, ($prices->total_base_price/$rate_round) )*$rate_round;
      $roz_price = call_user_func( $rate_round_side, ($prices->total_price/$rate_round) )*$rate_round;
      
      ?>
      <div class="text-right h4">
        <div>Общая оптовая цена: <?php print $opt_price; ?> <?php print $warehouse_currency; ?></div>
        <div>Общая розничная цена: <?php print $roz_price; ?> <?php print $warehouse_currency; ?></div>
      </div>
    </div>
  <?php endif; ?>
